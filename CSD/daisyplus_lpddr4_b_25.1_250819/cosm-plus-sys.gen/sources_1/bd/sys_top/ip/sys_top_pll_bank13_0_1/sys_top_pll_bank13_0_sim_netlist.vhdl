...
-- Command     : write_vhdl -force -mode funcsim -rename_top sys_top_pll_bank13_0 -prefix
--               sys_top_pll_bank13_0_ sys_top_pll_bank13_0_sim_netlist.vhdl
...
entity sys_top_pll_bank13_0_sys_top_pll_bank13_0_clk_wiz is
  port (
...
end sys_top_pll_bank13_0_sys_top_pll_bank13_0_clk_wiz;

architecture STRUCTURE of sys_top_pll_bank13_0_sys_top_pll_bank13_0_clk_wiz is
  signal clk_in1_sys_top_pll_bank13_0 : STD_LOGIC;
  signal clk_out1_sys_top_pll_bank13_0 : STD_LOGIC;
  signal clk_out2_sys_top_pll_bank13_0 : STD_LOGIC;
  signal clk_out3_sys_top_pll_bank13_0 : STD_LOGIC;
  signal clkfbout_buf_sys_top_pll_bank13_0 : STD_LOGIC;
  signal clkfbout_sys_top_pll_bank13_0 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clkfbout_sys_top_pll_bank13_0,
      O => clkfbout_buf_sys_top_pll_bank13_0
    );
clkin1_bufg: unisim.vcomponents.BUFGCE
    generic map(
      ...
      CE => '1',
      I => clk_in1,
      O => clk_in1_sys_top_pll_bank13_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_sys_top_pll_bank13_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_sys_top_pll_bank13_0,
      O => clk_out2
    );
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out3_sys_top_pll_bank13_0,
      O => clk_out3
    );
...
entity sys_top_pll_bank13_0 is
  ...
  attribute NotValidForBitStream of sys_top_pll_bank13_0 : entity is true;
end sys_top_pll_bank13_0;

architecture STRUCTURE of sys_top_pll_bank13_0 is
begin
inst: entity work.sys_top_pll_bank13_0_sys_top_pll_bank13_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
