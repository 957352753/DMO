...
// Command     : write_verilog -force -mode synth_stub -rename_top sys_top_smartconnect_0_0 -prefix
//               sys_top_smartconnect_0_0_ sys_top_smartconnect_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "sys_top_smartconnect_0_0,bd_fa2a,{}" *) (* CORE_GENERATION_INFO = "sys_top_smartconnect_0_0,bd_fa2a,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=27,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_fa2a,Vivado 2025.1" *) 
module sys_top_smartconnect_0_0(aclk, aresetn, S00_AXI_awid, S00_AXI_awaddr, 
...
/* synthesis syn_force_seq_prim="aclk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.aclk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 249997498, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN sys_top_zynq_ultra_ps_e_0_0_pl_clk3, ASSOCIATED_BUSIF M00_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken" *) input aclk /* synthesis syn_isclock = 1 */;
