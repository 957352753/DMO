...
-- Command     : write_vhdl -force -mode synth_stub -rename_top sys_top_hpic_0_upgraded_ipi_imp_xbar_0 -prefix
--               sys_top_hpic_0_upgraded_ipi_imp_xbar_0_ sys_top_hpic_0_upgraded_ipi_imp_xbar_0_stub.vhdl
...
entity sys_top_hpic_0_upgraded_ipi_imp_xbar_0 is
  ...
  attribute CORE_GENERATION_INFO of sys_top_hpic_0_upgraded_ipi_imp_xbar_0 : entity is "sys_top_hpic_0_upgraded_ipi_imp_xbar_0,axi_crossbar_v2_1_37_axi_crossbar,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_crossbar,x_ipVersion=2.1,x_ipCoreRevision=37,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynquplus,C_NUM_SLAVE_SLOTS=4,C_NUM_MASTER_SLOTS=1,C_AXI_ID_WIDTH=2,C_AXI_ADDR_WIDTH=32,C_AXI_DATA_WIDTH=64,C_AXI_PROTOCOL=0,C_NUM_ADDR_RANGES=1,C_M_AXI_BASE_ADDR=0x0000000000000000,C_M_AXI_ADDR_WIDTH=0x0000001f,C_S_AXI_BASE_ID=0x00000003000000020000000100000000,C_S_AXI_THREAD_ID_WIDTH=0x00000000000000000000000000000000,C_AXI_SUPPORTS_USER_SIGNALS=0,C_AXI_AWUSER_WIDTH=1,C_AXI_ARUSER_WIDTH=1,C_AXI_WUSER_WIDTH=1,C_AXI_RUSER_WIDTH=1,C_AXI_BUSER_WIDTH=1,C_M_AXI_WRITE_CONNECTIVITY=0x0000000f,C_M_AXI_READ_CONNECTIVITY=0x0000000f,C_R_REGISTER=0,C_S_AXI_SINGLE_THREAD=0x00000000000000000000000000000000,C_S_AXI_WRITE_ACCEPTANCE=0x00000004000000040000000400000004,C_S_AXI_READ_ACCEPTANCE=0x00000004000000040000000400000004,C_M_AXI_WRITE_ISSUING=0x00000010,C_M_AXI_READ_ISSUING=0x00000010,C_S_AXI_ARB_PRIORITY=0x00000000000000000000000000000000,C_M_AXI_SECURE=0x00000000,C_CONNECTIVITY_MODE=1}";
...
architecture stub of sys_top_hpic_0_upgraded_ipi_imp_xbar_0 is
