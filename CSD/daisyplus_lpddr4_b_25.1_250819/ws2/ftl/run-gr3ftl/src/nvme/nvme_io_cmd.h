...
void handle_io_auto_from_host(unsigned int cmdSlotTag, NVME_IO_COMMAND *nvmeIOCmd);
void my_handle_io_copy_from_host(NVME_IO_COMMAND *nvmeIOCmd, NVME_COMPLETION *nvmeCPL);
