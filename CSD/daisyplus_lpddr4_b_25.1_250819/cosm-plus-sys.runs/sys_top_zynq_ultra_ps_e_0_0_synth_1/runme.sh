...
HD_PWD='D:/tmp/daisyplus_lpddr4_b_25.1_250819/cosm-plus-sys.runs/sys_top_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sys_top_zynq_ultra_ps_e_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sys_top_zynq_ultra_ps_e_0_0.tcl
