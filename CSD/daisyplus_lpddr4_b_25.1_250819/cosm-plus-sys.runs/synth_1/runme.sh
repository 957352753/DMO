...
HD_PWD='D:/tmp/daisyplus_lpddr4_b_25.1_250819/cosm-plus-sys.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sys_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sys_top_wrapper.tcl
