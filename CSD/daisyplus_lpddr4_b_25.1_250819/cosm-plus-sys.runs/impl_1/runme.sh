...
HD_PWD='D:/tmp/daisyplus_lpddr4_b_25.1_250819/cosm-plus-sys.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sys_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sys_top_wrapper.tcl -notrace
