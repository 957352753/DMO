...
#
# Script generated by Vivado on Tue Aug 19 15:11:46 +0900 2025
...
#
# Usage        : sys_top.sh
#                sys_top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sys_top.sh [-reset_run]
#                sys_top.sh [-reset_log]
#                sys_top.sh [-help]
#
...
# script info
echo -e "sys_top.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sys_top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L zynq_ultra_ps_e_vip_v1_0_21 -L axi_bram_ctrl_v4_1_13 -L blk_mem_gen_v8_4_11 -L generic_baseblocks_v2_1_2 -L axi_register_slice_v2_1_35 -L fifo_generator_v13_2_13 -L axi_data_fifo_v2_1_35 -L axi_crossbar_v2_1_37 -L proc_sys_reset_v5_0_17 -L xlconcat_v2_1_7 -L xlconstant_v1_1_10 -L smartconnect_v1_0 -L gtwizard_ultrascale_v1_7_20 -L axi_clock_converter_v2_1_34 -L axi_protocol_converter_v2_1_36 -L axi_dwidth_converter_v2_1_36 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sys_top xil_defaultlib.sys_top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sys_top -key {Behavioral:sim_1:Functional:sys_top} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_fa2a.protoinst" -protoinst "protoinst_files/sys_top.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sys_top.wdb xsim.dir libdpi.so)
...
Usage: sys_top.sh [-step]\n\
Usage: sys_top.sh [-lib_map_path]\n\
Usage: sys_top.sh [-reset_run]\n\
Usage: sys_top.sh [-reset_log]\n\
Usage: sys_top.sh [-keep_index]\n\
