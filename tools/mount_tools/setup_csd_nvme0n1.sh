...
#   and mounting an NVMe device (e.g., /dev/nvme0n1)
# =========================================================
...
lspci | grep -i "Xilinx" || echo "⚠ 未检测到 Xilinx NVMe 控制器"

echo
echo "=== Step 2: 检查 NVMe 设备是否存在 ==="
ls /dev | grep "nvme" || echo "⚠ 未找到 NVMe 设备"
...
sudo mount /dev/nvme0n1p1 "$MOUNT_POINT"
