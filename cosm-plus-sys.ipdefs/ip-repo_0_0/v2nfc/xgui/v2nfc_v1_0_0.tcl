...
proc init_gui { IPINST } {
  ...
  ipgui::add_static_text $IPINST -name "Buffer Type" -parent ${Page_0} -text {Buffer Type
0: IN_FIFO
1: Async BRAM FIFO
}
  ...
  ipgui::add_static_text $IPINST -name "Input Clock Buffer Type" -parent ${Page_0} -text {Input Clock Buffer Type
0: IBUFG
1: IBUFG-BUFG
2: BUFR
}
