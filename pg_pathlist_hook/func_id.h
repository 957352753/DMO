...
#define   DATE_LT_TIMESTAMP     2338
#define   DATE_LE_TIMESTAMP     2339
#define   DATE_EQ_TIMESTAMP     2340
#define   DATE_GT_TIMESTAMP     2341
#define   DATE_GE_TIMESTAMP     2342
#define   DATE_NE_TIMESTAMP     2343
#define   DATE_CMP_TIMESTAMP    2344

#define   TIMESTAMP_LT_DATE     2364 //timestamp_lt_date
#define   TIMESTAMP_LE_DATE     2365 //timestamp_le_date
#define   TIMESTAMP_EQ_DATE     2366 //timestamp_eq_date
#define   TIMESTAMP_GT_DATE     2367 //timestamp_gt_date
#define   TIMESTAMP_GE_DATE     2368 //timestamp_ge_date
#define   TIMESTAMP_NE_DATE     2369 //timestamp_ne_date
#define   TIMESTAMP_CMP_DATE    2370 //timestamp_cmp_date

extern unsigned short func_id_support_hash[65536];
