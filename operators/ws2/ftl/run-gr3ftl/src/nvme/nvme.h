...
#define IO_NVM_ADDONE                                       0x0a
#define IONVM_FILTER_SEND                                   0xcd
#define IONVM_FILTER_RESULT                                 0xce
#define IONVM_FILTER_PROFILE_RESULT                         0xcf
#define IONVM_FILTER                                        IONVM_FILTER_SEND
/*Status Code Type */
...
extern int ADD_ONE_TAG;
extern int ADD_ONE_TAG1;
extern int FILTER_TAG;
