...
#define NSC_3_UCODEADDR XPAR_AXI_BRAM_CTRL_3_BASEADDR
...
#define NSC_2_UCODEADDR XPAR_AXI_BRAM_CTRL_2_BASEADDR
...
#define NSC_1_UCODEADDR XPAR_AXI_BRAM_CTRL_1_BASEADDR
...
#define NSC_0_UCODEADDR XPAR_AXI_BRAM_CTRL_0_BASEADDR
...
/*
 * Smoke-test mode for validating the NVMe vendor command path when NAND
 * ReadId is not returning. Disable this for real table scans from NAND.
 */
#define FILTER_ACCEL_SMOKE_SKIP_NAND_INIT 0
#define FILTER_ACCEL_NAND_DIAG_ON_BOOT 1

#ifndef FTL_BOOT_PROGRESS_ENABLE
#define FTL_BOOT_PROGRESS_ENABLE 1
#endif

#ifndef FTL_ERASE_USER_BLOCK_ON_BOOT
#define FTL_ERASE_USER_BLOCK_ON_BOOT 1
#endif

#ifndef FTL_RECOVER_BAD_BLOCK_TABLE_ON_BOOT
#define FTL_RECOVER_BAD_BLOCK_TABLE_ON_BOOT 0
#endif

#ifndef FTL_ERASE_PROGRESS_INTERVAL_BLOCKS
#define FTL_ERASE_PROGRESS_INTERVAL_BLOCKS 128
#endif
