...
if(DEFINED FILTER_ACCEL_ENABLE)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_ACCEL_ENABLE=${FILTER_ACCEL_ENABLE}")
endif()
if(DEFINED FTL_BOOT_PROGRESS_ENABLE)
    list(APPEND USER_COMPILE_DEFINITIONS "FTL_BOOT_PROGRESS_ENABLE=${FTL_BOOT_PROGRESS_ENABLE}")
endif()
if(DEFINED FTL_ERASE_USER_BLOCK_ON_BOOT)
    list(APPEND USER_COMPILE_DEFINITIONS "FTL_ERASE_USER_BLOCK_ON_BOOT=${FTL_ERASE_USER_BLOCK_ON_BOOT}")
endif()
if(DEFINED FTL_RECOVER_BAD_BLOCK_TABLE_ON_BOOT)
    list(APPEND USER_COMPILE_DEFINITIONS "FTL_RECOVER_BAD_BLOCK_TABLE_ON_BOOT=${FTL_RECOVER_BAD_BLOCK_TABLE_ON_BOOT}")
endif()
if(DEFINED FTL_ERASE_PROGRESS_INTERVAL_BLOCKS)
    list(APPEND USER_COMPILE_DEFINITIONS "FTL_ERASE_PROGRESS_INTERVAL_BLOCKS=${FTL_ERASE_PROGRESS_INTERVAL_BLOCKS}")
endif()
if(DEFINED DATA_BUFFER_ENTRIES_PER_DIE)
    list(APPEND USER_COMPILE_DEFINITIONS "DATA_BUFFER_ENTRIES_PER_DIE=${DATA_BUFFER_ENTRIES_PER_DIE}")
endif()
if(DEFINED REQUEST_ENTRIES_PER_DIE)
    list(APPEND USER_COMPILE_DEFINITIONS "REQUEST_ENTRIES_PER_DIE=${REQUEST_ENTRIES_PER_DIE}")
endif()
if(DEFINED FILTER_ACCEL_VERIFY_ENABLE)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_ACCEL_VERIFY_ENABLE=${FILTER_ACCEL_VERIFY_ENABLE}")
endif()
if(DEFINED FILTER_FORCE_ARM_FALLBACK)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_FORCE_ARM_FALLBACK=${FILTER_FORCE_ARM_FALLBACK}")
endif()
if(DEFINED FILTER_RESULT_MAX_PAGES)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_RESULT_MAX_PAGES=${FILTER_RESULT_MAX_PAGES}")
endif()
if(DEFINED FILTER_PROJECTION_ENABLE)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_PROJECTION_ENABLE=${FILTER_PROJECTION_ENABLE}")
endif()
if(DEFINED FILTER_PROJECTION_STAGING_BYTES_PER_PAGE)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_PROJECTION_STAGING_BYTES_PER_PAGE=${FILTER_PROJECTION_STAGING_BYTES_PER_PAGE}")
endif()
if(DEFINED FILTER_PROJECTION_DEFAULT_MAX_ROW_BYTES)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_PROJECTION_DEFAULT_MAX_ROW_BYTES=${FILTER_PROJECTION_DEFAULT_MAX_ROW_BYTES}")
endif()
if(DEFINED FILTER_COMPUTE_ENABLE)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_COMPUTE_ENABLE=${FILTER_COMPUTE_ENABLE}")
endif()
if(DEFINED FILTER_HASH_JOIN_ENABLE)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_HASH_JOIN_ENABLE=${FILTER_HASH_JOIN_ENABLE}")
endif()
if(DEFINED FILTER_COMPUTE_MAX_SORT_ROWS)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_COMPUTE_MAX_SORT_ROWS=${FILTER_COMPUTE_MAX_SORT_ROWS}")
endif()
if(DEFINED FILTER_COMPUTE_MAX_TUPLE_BYTES)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_COMPUTE_MAX_TUPLE_BYTES=${FILTER_COMPUTE_MAX_TUPLE_BYTES}")
endif()
if(DEFINED FILTER_COMPUTE_WORK_BYTES)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_COMPUTE_WORK_BYTES=${FILTER_COMPUTE_WORK_BYTES}")
endif()
if(DEFINED FILTER_JOIN_MIN_BUCKETS)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_JOIN_MIN_BUCKETS=${FILTER_JOIN_MIN_BUCKETS}")
endif()
if(DEFINED FILTER_JOIN_MAX_BUCKETS)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_JOIN_MAX_BUCKETS=${FILTER_JOIN_MAX_BUCKETS}")
endif()
if(DEFINED FILTER_JOIN_MAX_BUILD_ROWS)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_JOIN_MAX_BUILD_ROWS=${FILTER_JOIN_MAX_BUILD_ROWS}")
endif()
if(DEFINED FILTER_JOIN_MAX_OUTPUT_ROWS)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_JOIN_MAX_OUTPUT_ROWS=${FILTER_JOIN_MAX_OUTPUT_ROWS}")
endif()
if(DEFINED FILTER_JOIN_WORK_BYTES)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_JOIN_WORK_BYTES=${FILTER_JOIN_WORK_BYTES}")
endif()
if(DEFINED FILTER_STAGING_BATCH_PAGES)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_STAGING_BATCH_PAGES=${FILTER_STAGING_BATCH_PAGES}")
endif()
if(DEFINED FILTER_STAGING_BATCH_ENABLE)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_STAGING_BATCH_ENABLE=${FILTER_STAGING_BATCH_ENABLE}")
endif()
if(DEFINED FILTER_DEFER_READY_ENABLE)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_DEFER_READY_ENABLE=${FILTER_DEFER_READY_ENABLE}")
endif()
if(DEFINED FILTER_DEFER_DRAIN_LOW_WATERMARK)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_DEFER_DRAIN_LOW_WATERMARK=${FILTER_DEFER_DRAIN_LOW_WATERMARK}")
endif()
if(DEFINED FILTER_DEFER_DRAIN_HIGH_WATERMARK)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_DEFER_DRAIN_HIGH_WATERMARK=${FILTER_DEFER_DRAIN_HIGH_WATERMARK}")
endif()
if(DEFINED FILTER_DEFER_DRAIN_BUDGET)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_DEFER_DRAIN_BUDGET=${FILTER_DEFER_DRAIN_BUDGET}")
endif()
if(DEFINED FILTER_DIRECT_COALESCE_ENABLE)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_DIRECT_COALESCE_ENABLE=${FILTER_DIRECT_COALESCE_ENABLE}")
endif()
if(DEFINED FILTER_DIRECT_COALESCE_PAGES)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_DIRECT_COALESCE_PAGES=${FILTER_DIRECT_COALESCE_PAGES}")
endif()
if(DEFINED FILTER_DIRECT_ASYNC_ENABLE)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_DIRECT_ASYNC_ENABLE=${FILTER_DIRECT_ASYNC_ENABLE}")
endif()
if(DEFINED FILTER_DIRECT_ASYNC_RECHECK_WATERMARK_ENABLE)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_DIRECT_ASYNC_RECHECK_WATERMARK_ENABLE=${FILTER_DIRECT_ASYNC_RECHECK_WATERMARK_ENABLE}")
endif()
if(DEFINED FILTER_ACCEL_POLL_SERVICE_ENABLE)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_ACCEL_POLL_SERVICE_ENABLE=${FILTER_ACCEL_POLL_SERVICE_ENABLE}")
endif()
if(DEFINED FILTER_ACCEL_POLL_SERVICE_INTERVAL)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_ACCEL_POLL_SERVICE_INTERVAL=${FILTER_ACCEL_POLL_SERVICE_INTERVAL}")
endif()
if(DEFINED FILTER_ACCEL_INPUT_CACHE_OP)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_ACCEL_INPUT_CACHE_OP=${FILTER_ACCEL_INPUT_CACHE_OP}")
endif()
if(DEFINED FILTER_MAX_BLOCK_COUNT)
    list(APPEND USER_COMPILE_DEFINITIONS "FILTER_MAX_BLOCK_COUNT=${FILTER_MAX_BLOCK_COUNT}")
endif()
...
"nvme/nvme.c"
"nvme/page.c"
"nvme/filter_common.c"
"nvme/filter_tuple.c"
"nvme/filter_accel.c"
"nvme/filter_projection.c"
"nvme/filter_compute.c"
"nvme/filter_join.c"
...
if(NOT DEFINED FIRMWARE_OPTIMIZATION_LEVEL)
    set(FIRMWARE_OPTIMIZATION_LEVEL "O0")
endif()
if(NOT FIRMWARE_OPTIMIZATION_LEVEL MATCHES "^(O0|O1|O2|O3|Os)$")
    message(FATAL_ERROR
        "FIRMWARE_OPTIMIZATION_LEVEL must be O0, O1, O2, O3, or Os")
endif()
set(USER_COMPILE_OPTIMIZATION_LEVEL "-${FIRMWARE_OPTIMIZATION_LEVEL}")
