...
#define	AVAILABLE_OUNTSTANDING_REQ_COUNT			((USER_DIES) * REQUEST_ENTRIES_PER_DIE)  //regardless of request type

#if AVAILABLE_OUNTSTANDING_REQ_COUNT >= 0xffff
#error "request pool must fit in the 16-bit request slot tag"
#endif
